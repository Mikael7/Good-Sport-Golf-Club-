...
export default function Title() {
    ...
    return (
            ...
            <div>
                    ...
                    <div className=''>
                        <div className="m-20 flex flex-row justify-evenly">
                            ...
                            <div className="w-52 rounded-xl bg-lightgreen">
                                ...
                                <div className="p-2 border-gray-200 center">
                                    <div className="">
                                        <p className="text-white text-center font-medium"><b>Elite Play</b></p>
                                    </div>
                                    <p className="text-white text-center text-sm my-1">Competitive yet fun atmosphere.</p>
                                </div>
                            </div>
                            <div className="w-52 rounded-xl">
                                <div className="h-48 flex items-center justify-center">
                ...
                <div className="flex flex-row justify-evenly pt-2 pb-2">
                    <div className="w-3/4 flex gap-8">
                        <div className="bg-white shadow-2xl rounded-lg py-4 flex flex-col items-center justify-between">
                            ...
                            <div className="flex items-center justify-center mt-6">
                                <a href="#" className="bg-lightgreen hover:bg-blue-700 px-8 py-2 text-sm text-white uppercase rounded font-bold transition duration-150" title="Purchase">Purchase</a>
                            </div>
                        </div>
                        <div className="bg-white shadow-2xl rounded-lg py-4 flex flex-col items-center justify-between">
        ...
        <div className="mb-20">
                        <div className="px-6 text-gray-600 mx-40">
