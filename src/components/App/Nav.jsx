          ...
          <div className="mx-auto flex items-center justify-between">
            ...
            <div className="flex md:order-2">
              <div className="relative mr-3 md:mr-0 hidden md:block">
                <Link to = "/Donate" className="bg-lightgreen text-white sm:text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2"><button> Donate Now</button> </Link> 
              </div>
            </div>
            <div className="hidden md:flex justify-between items-center w-full md:w-auto md:order-1" id="mobile-menu-3">
              <ul className="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                ...
                {/* <li>
                  <Link to = "/Donate" className="text-gray-700 hover:bg-gray-50 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0"><b>Donate Now</b></Link>
                </li>         */}
              </ul>
            </div>
          </div>
