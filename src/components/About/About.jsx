export default function About() {
    return (
            ...
            <div className="md:5/12 lg:w-5/12">
                <img src="https://images.unsplash.com/photo-1443706340763-4b60757a36ce?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1935&q=80" style= {{height: "100%"}} alt="image" loading="lazy" width="" height="" />
            </div>
            <div className="px-14 md:7/12 lg:w-6/12" style={{marginTop: 0}}>
